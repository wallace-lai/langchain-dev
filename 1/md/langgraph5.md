...
1. Coding up Looping Logic

## 2. 实现

要实现如下带循环的StateGraph，需要使用循环逻辑。
...
flowchart TD
    ...
    START --> greeting_node
    greeting_node --> random_node
    random_node -. loop .-> random_node
    random_node -. exit .-> END
```
